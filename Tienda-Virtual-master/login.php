  ...
  <body>
    ...
    <div class="single-product-area">
        ...
        <div class="container">
                ...
                <p class="product-wid-title">Si ha comprado con nosotros antes, por favor ingrese sus datos en las casillas de abajo. Si es un nuevo cliente, por favor, vaya a la sección de <a href="registro.php">Registro de Usuario Nuevo</a></p>
