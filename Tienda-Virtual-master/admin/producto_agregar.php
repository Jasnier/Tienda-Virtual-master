...
if (isset($_POST["agregarProducto"]) && $_POST["agregarProducto"] == "agregarProducto") {
    ...
    echo '<script>alert("El precio no puede tener ese valor");</script>';
...
<head>
    ...
    <script
        src="https://cdnjs.cloudflare.com/ajax/libs/jquery.bootstrapvalidator/0.5.0/js/bootstrapValidator.min.js"></script>
...
<body>
    ...
    ?>
    <div class="container">
        <form class="well form-horizontal" method="post" enctype="multipart/form-data" id="agregarProducto"
            name="registro">
            <fieldset>
                <!-- Form Name -->
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            ...
                            <input name="frase_promocional" placeholder="Frase Promocional" class="form-control"
                                type="text" required>
                        </div>
                    </div>
                </div>
                ...
                <!-- Success message -->
                <div class="alert alert-success" role="alert" id="success_message">¡El producto se ha agregado
                    correctamente!</div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <button type="submit" class="btn btn-warning" name="agregarProducto"
                            value="agregarProducto">Agregar Producto</button>
                    </div>
                </div>
            </fieldset>
        </form>
