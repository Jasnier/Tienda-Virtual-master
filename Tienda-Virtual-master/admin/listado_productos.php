        ...
        <tbody>
          <?php while ($row = $resource->fetch_assoc()) { ?>
            ...
            <tr>
              ...
              <td class="col-xs-3 col-sm-3 col-md-4 col-lg-3">
                <?php echo $row["promocion"] ?>
              </td>
              <td class="col-xs-3 col-sm-3 col-md-4 col-lg-3"><a href="producto_modificar.php?id=<?php echo $row["id"] ?>"
                  class="btn btn-md btn-success"><span class="glyphicon glyphicon-wrench" aria-hidden="true"></span></a>
              </td>
              <td class="col-xs-3 col-sm-3 col-md-4 col-lg-3"><a
                  href="listado_productos.php?idElm=<?php echo $row["id"] ?>" class="btn btn-md btn-danger"
